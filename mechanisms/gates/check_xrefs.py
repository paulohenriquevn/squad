...
AUXILIARY_SKILLS = {"ast-grep", "honesty-gate", "backlog-init", "backlog-review", "session-goal", "quality-init", "skill-creator", "arch-check", "squad-fit", "sign", "panel", "issue-confidence"}
