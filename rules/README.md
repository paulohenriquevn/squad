...
That makes the pointer the whole interface, and a pointer at fifty-eight files is
not one — a model told to read fifty-eight files before an architectural decision
