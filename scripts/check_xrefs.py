...
AUXILIARY_SKILLS = {"ast-grep", "deck", "marp-slide", "excalidraw", "dogfood", "roadmap-init", "roadmap-feature", "roadmap-review", "backlog-init", "cycle-goal", "plan-help", "quality-init", "skill-creator", "frontend-design"}
