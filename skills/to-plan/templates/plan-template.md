...
This file is the canonical template referenced from `to-plan/SKILL.md § Plan Template`. To produce a new plan, copy everything inside the `<plan-template>` block below into `records/plans/{slug}-plan.md` and replace placeholders.
