...
2. Prior opportunities under `.squad/records/discoveries/opportunities/` touching the same repo. A hypothesis measured and killed three months ago deserves to know that before being measured again.
...
```
.squad/records/discoveries/plans/{slug}-plan.md
```
