...
Toy plan for testing `check_coverage_matrix.py`, `check_adr_completeness.py`, `check_tdd_in_bugfix.py`, `check_spec_smells.py`. Compliance: cita `architecture.md`, `testing.md`, SOLID, DRY.
