...
33 markdown-based skills that serve as entry-points for the Squad pipeline
...
| `cap-theorem-specialist` | Analisa trade-offs CP/AP em arquiteturas distribuídas |
