...
``plan-confidence` and `discover-confidence`` — and the three syntax trees differed in **four lines of 89, all of them the
...
the RUBRIC this skill reads — `rubric-measurement-plan.md` — because the categories, patterns and penalties
