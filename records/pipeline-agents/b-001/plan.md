---
name: pipeline-b-001-plan
description: PLAN stage for B-001, reached only when the alignment brief cleared the gate. Outlines the tasks the plan would carry and names what the brief does not answer. Generated 2026-08-31 by the pipeline orchestrator.
...
You are the PLAN phase for `B-001`, in your own worktree over `/home/paulo/Projetos/theo/theo-platform/theo`. You are
